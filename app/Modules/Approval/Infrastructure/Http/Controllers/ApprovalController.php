...
use App\Modules\Approval\Infrastructure\Http\Requests\ApprovalRequest;
...
{
    public function __invoke(ApprovalRequest $request, ApprovalService $approvalService): JsonResponse
    {
        try {
            $model = $approvalService->apply($request->dto());
